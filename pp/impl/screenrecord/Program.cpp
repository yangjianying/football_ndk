...
void Program::release() {
    ALOGV("Program::release, mProgram:%d ", mProgram);
    if (mProgram != 0) {
...
/* static */status_t Program::createProgram(GLuint* outPgm, const char* vertexShader,
...
/* static */status_t Program::compileShader(GLenum shaderType, const char* src,
        GLuint* outShader) {
...
/* static */status_t Program::linkShaderProgram(GLuint vs, GLuint fs, GLuint* outPgm) {
