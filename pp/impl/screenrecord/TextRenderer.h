...
public:
    ...
    void drawString(const Program& program, const float* texMatrix,
            float x, float y, /*const String8& str*/ char *str) const;
...
private:
    ...
    float computeScaledStringWidth(/*const String8& str8*/ char *str) ; // const;

    // Computes the width of first N characters in the string.
    float computeScaledStringWidth(char* str, size_t len) ; // const;
