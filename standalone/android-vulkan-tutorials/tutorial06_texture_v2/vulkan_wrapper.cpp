...
int InitVulkan(void) {
    ...
    LOGW("%s libvulkan:%p ", __func__, libvulkan);
	...
	vkGetMemoryAndroidHardwareBufferANDROID = reinterpret_cast<PFN_vkGetMemoryAndroidHardwareBufferANDROID>(dlsym(libvulkan, "vkGetMemoryAndroidHardwareBufferANDROID"));
#endif
