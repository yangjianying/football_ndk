...
*/
#define DATA_READER_FORMAT (AIMAGE_FORMAT_RGBA_8888) // 0x01
	// VK_FORMAT_R8G8B8A8_UNORM
	// GL_RGBA8
//#define DATA_READER_FORMAT (AIMAGE_FORMAT_RGBX_8888) // 0x02
	// VK_FORMAT_R8G8B8A8_UNORM
	// GL_RGB8
//#define DATA_READER_FORMAT (AIMAGE_FORMAT_RGB_888) // 0x03
	// VK_FORMAT_R8G8B8_UNORM
	// GL_RGB8
//#define DATA_READER_FORMAT (AIMAGE_FORMAT_RGB_565) // 0x04
	// VK_FORMAT_R5G6B5_UNORM_PACK16
	// GL_RGB565
//#define DATA_READER_FORMAT (AIMAGE_FORMAT_RGBA_FP16) // 0x16
...
public:
	HistogramDataReader(int width, int height): TestReader(
		width, height, DATA_READER_FORMAT, 3, 
...
/** here render into a ANativeWindow (wether it is from a Display Surafce or a Image Reader ) */
