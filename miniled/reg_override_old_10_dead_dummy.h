...
//-----------------------------------------------------------------------------------------------------------------------------
	// Dummy time width
	else if(addr_ == 0X0001) { return 500; }	// (24)0x0018 // Reserve
//-----------------------------------------------------------------------------------------------------------------------------
	// Dead time width
	else if(addr_ == 0X0002) { return 500; }	// (72)0x0048 // Reserve
//-----------------------------------------------------------------------------------------------------------------------------
	// Scan change period
	else if(addr_ == 0X0003) { return 240; }	// (24)0x0018 // scan change period. SC[15:0] x GCLK period
//----------------------------------------------------------------------------------------------------------------------------
	// Scan separate period
	else if(addr_ == 0X0004) { return 240; }	// (24)0x0018 // MOS separate period, MS[15:0] x GCLK period
//-----------------------------------------------------------------------------------------------------------------------------
...
#define SW_Discharge_enable 1
	//[0]: Disable
	//[1]: Enable
#define SW_Discharge_voltage_level 0x07
	//[000]~[111]:
	//[000]=> VLED-VSW=4.64V
	//[100]=> VLED-VSW=2.77V
	//[111]=> VLED-VSW=1.17V
#define SW_Discharge_time 1
	//[0]: 1us
	//[1]: 2us
