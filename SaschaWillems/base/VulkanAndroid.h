...
extern android_app_* androidApp;
...
extern PFN_vkCreateBufferView vkCreateBufferView;  // frankie, add
extern PFN_vkDestroyBufferView vkDestroyBufferView; // frankie, add
