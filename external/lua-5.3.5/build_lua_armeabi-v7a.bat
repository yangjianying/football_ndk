...
SET LUA_SRC_DIR=.
SET OUTPUT_DIR=lua-build-armeabiv7a
SET ANDROID_PATH=C:\Users\hp\AppData\Local\Android\Sdk
SET NDK_PATH=C:\Users\hp\AppData\Local\Android\Sdk\ndk\20.1.5948944
SET NDK_TOOLCHAIN=D:\vulkan\SaschaWillems\SaschaWillems\android_standalong_toolchain\android-toolchain-24-llvm-armeabi-v7a
